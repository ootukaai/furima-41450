...
ActiveRecord::Schema[7.0].define(version: 2024_09_03_073355) do
  ...
  create_table "prefectures", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["history_id"], name: "index_prefectures_on_history_id"
  end
  ...
  add_foreign_key "prefectures", "histories"
end
